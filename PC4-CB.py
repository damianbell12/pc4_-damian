...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>el blog de damian</h1>", unsafe_allow_html=True)
    ...
    col1.image("pc4_perfil.jpg", caption='damian perfil', width=300)
    ...
    texto = """
   Hola soy Damián Ccari Bellido, soy de Lima-Perú estudio la carrera de Publicidad. De mi carrera me gusta la forma en la que proyectamos la identidad o información de un cliente, me gustaría empezar a adquirir conocimiento de los que mas saben en mi rubro y después replicar las mejores acciones; en mis tiempos libres me gusta jugar futbol, caminar en la playa y practicar deportes al aire libre como el skate, correr en las madrugadas.
    """
    ...
    texto_2 = """
    La verdad que me sentí con mucho entusiasmo a lo largo del ciclo, cada clase fue un desafío y aunque se me complico a la mitad del ciclo fue muy bonita experiencia. La programación me enseño que cada digito o carácter importa muchísimo a la hora de construir un sistema.Cuando programo me gusta la hora que sale el constructo de manera óptima; para culminar me gustaría crea paginas propias de manera mas fluida en un futuro."""
    ...
    st.markdown("<h2 style='text-align: center;'>video del blog</h2>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://drive.google.com/file/d/1u3cX2bbImWt3dR6bTLzItYXQuPCb7yrJ/view' target='_blank'><button>Ver video</button></a></div>", unsafe_allow_html=True) 
    ...
    graficos = ['histograma','Gráfico de barras', 'Gráfico de pastel', 'mapa peliculas']
    ...
    if grafico_seleccionado == 'histograma':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>en esta seccion se muestran los goles anotados del real madrid como local y visitante; tambien se puede apreciar los goles recibidos como local y vistante.</div>", unsafe_allow_html=True)
        st.image("histograma.png", caption='histograma', width=500)
        pass
    elif grafico_seleccionado == 'Gráfico de barras':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>en este lugar se muestra el promedio de las tarjetas por equipo, de condicion de local, de la liga.</div>", unsafe_allow_html=True)
        st.image("grafico_de_barras.png", caption='Gráfico de de barras', width=500)
        pass
    elif grafico_seleccionado == 'Gráfico de pastel':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>en este espacio se observan los partidos como visitante del barcelona del 2024/2025.</div>", unsafe_allow_html=True)
        st.image("grafico_de_pastel.png", caption='Gráfico de pastel', width=500)
        pass
    elif grafico_seleccionado == 'mapa peliculas':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>MAPA CON UBICACIONES EN EL NORTE DE AMERICA Y EL NORTE DE EUROPA</div>", unsafe_allow_html=True)
        # Si "mapa_cusco.html" es un archivo HTML (no una imagen), debes mostrarlo con st.components.v1.html
        import streamlit.components.v1 as components
        with open("mapa_interactivo_peliculas.html", "r", encoding="utf-8") as f:
            html_content = f.read()
